...
describe('Amortization Schedule', () => {
  it('should calculate correct amortization schedule for 5-year term', () => {
    ...
    const apr = 8.9;
    const termYears = 5;
    // Calculate the correct monthly payment using the amortization formula
    ...
    expect(schedule.monthlyPayment).toBeCloseTo(monthlyPayment, 2);
    ...
    expect(firstMonth.totalPayment).toBeCloseTo(monthlyPayment, 1);
